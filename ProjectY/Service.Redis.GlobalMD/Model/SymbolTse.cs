...
namespace Service.Redis.GlobalMD.Model
{
    [Serializable]
    public class SymbolTse : INotifyPropertyChanged
    {
        public SymbolTse()
        { }
        ...
        public SymbolTse(MarketDataApi.PacketTSE.Format1 data)
        {
            ...
            _stkCountMark = data.StkCountMark;
            ...
            //---------其他
            _foreignStkCode = data.ForeignStkCode;
            _unit = data.Unit;
        ...
        //---------其他
        private string _foreignStkCode;
        private int _unit;
        ...
        /// 國外識別碼
        /// </summary>
        public string ForeignStkCode
        {
            get
            {
                return _foreignStkCode;
            }
            internal set
            {
                if (_foreignStkCode == value)
                    return;

                _foreignStkCode = value;
                OnPropertyChanged("ForeignStkCode");
            }
        }
        /// <summary>
        /// 每張單位
    ...
    [Serializable]
    public class SymbolTseList : ConcurrentDictionary<string, SymbolTse>
    {
        static SymbolTseList()
        {
            AllSymbolTseList = new SymbolTseList();
        }

        public static SymbolTseList AllSymbolTseList
        {
            get;
            internal set;
        }
