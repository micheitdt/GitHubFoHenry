...
namespace Adapter.ReplayRedisMD
{
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = MainWindow.SIZE_OF_EXCHANGENAME + 1)]
        public string ExchangeName;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = MainWindow.SIZE_OF_COMMODITYNAME + 1)]
        public string CommodityName;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = MainWindow.SIZE_OF_CONTRACTDATE + 1)]
